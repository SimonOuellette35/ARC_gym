...
def get_total_set():
    return [
        ...
        ('swap_pixels(%s,%s)' % (COLOR_MAP[1], COLOR_MAP[2]), partial(swap_pixels, from_color=1, to_color=2)),
        ('swap_pixels(%s,%s)' % (COLOR_MAP[1], COLOR_MAP[5]), partial(swap_pixels, from_color=1, to_color=5)),
        ('swap_pixels(%s,%s)' % (COLOR_MAP[1], COLOR_MAP[7]), partial(swap_pixels, from_color=1, to_color=7)),
        ('swap_pixels(%s,%s)' % (COLOR_MAP[3], COLOR_MAP[5]), partial(swap_pixels, from_color=3, to_color=5)),
        ('swap_pixels(%s,%s)' % (COLOR_MAP[3], COLOR_MAP[6]), partial(swap_pixels, from_color=3, to_color=6))
    ]
